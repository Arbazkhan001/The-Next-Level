...
class Button():
    ...
    def draw(self):
        ...
        # check the mouseover and clicked conditions
...
class Player():
    ...
    def update(self, game_over):
        ...
        if game_over == 0:
           ...
           draw_text('GAME OVER!',font, blue, (screen_width // 2) - 200, screen_hight // 2)
           if self.rect.y > 200:
            self.rect.y -= 5
...
#create dumy coin for showing the score
...
while run:
    ...
    if main_menu == True:
        ...
        #if player has completed he level
        if game_over == 1:
            ...
            if level <= max_levels:
                ...
                draw_text('YOU WIN!', font, blue, (screen_width // 2) - 140 , screen_hight // 2)
                if restart_button.draw():
                    level = 1
                 #reset level
                world_data = []
